...
class Team(QueryBase):
    ...
    def names(self):
        # Query 5
        # Write an SQL query that selects the team_name and team_id columns
    ...
    def username(self, id):
        ...
        # Use f-string formatting and a WHERE filter to only return the team name
        # related to the ID argument
        return f"""
            SELECT team_name
            FROM team
            WHERE team_id = {id}
